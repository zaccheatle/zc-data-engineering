...
## Description:
Dynamic Python script that allows the user to create a custom database in a PostgreSQL RDS instance in AWS from a folder of flatfiles (.csv, .xls, .xlsx format only). 
